...
mqsichangeproperties $broker -c MonitoringProfiles -o ORACLE_KIMBALLNUMBER_MF -n profileProperties -p /var/mqsi/monitoringprofiles/Profile_ORACLE_KIMBALLNUMBER_ORACLE_KIMBALLNUMBER_MF.xml
