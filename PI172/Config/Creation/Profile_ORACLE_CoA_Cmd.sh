...
mqsichangeproperties $broker -c MonitoringProfiles -o ORACLE_ESB_CoA -n profileProperties -p /var/mqsi/monitoringprofiles/ORACLE_ESB_CoA_PMF.xml
...
mqsichangeproperties $broker -c MonitoringProfiles -o ESB_PIAT_CoA_ACCOUNTS -n profileProperties -p /var/mqsi/monitoringprofiles/ESB_PIAT_CoA_ACCOUNTS_CMF.xml
...
mqsichangeproperties $broker -c MonitoringProfiles -o ESB_PIAT_CoA_PROJECTS -n profileProperties -p /var/mqsi/monitoringprofiles/ESB_PIAT_CoA_PROJECTS_CMF.xml
...
mqsichangeproperties $broker -c MonitoringProfiles -o ESB_PIAT_LOCATIONS -n profileProperties -p /var/mqsi/monitoringprofiles/ESB_PIAT_CoA_LOCATIONS_CMF.xml
...
mqsichangeproperties $broker -c MonitoringProfiles -o ESB_PIAT_CoA_COSTCENTRES -n profileProperties -p /var/mqsi/monitoringprofiles/ESB_PIAT_CoA_COSTCENTRES_CMF.xml
